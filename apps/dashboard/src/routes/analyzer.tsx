...
export const Route = createFileRoute("/analyzer")({
  head: () => ({
    meta: [
      ...
      {
        name: "description",
        content: "Categorize prompts, score complexity, and identify model-cascading cost savings.",
      },
    ],
  }),
    ...
    <div className="max-w-7xl mx-auto space-y-6">
      <div>
        ...
        <h1 className="font-display text-4xl">
          Right-size every <span className="prism-text">model call</span>.
        </h1>
      </div>
            ...
            {!selected ? (
              <div className="flex flex-col items-center justify-center text-center py-10">
                ...
                <p className="text-sm text-muted-foreground mt-1">
                  The analyzer rates complexity, categorizes the task, and flags cascading savings.
                </p>
              </div>
            ) : (
              <>
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                  ...
                  >
                    <GlassCard className="p-5">
                      ...
                      <div className="font-display text-2xl mt-2 capitalize">
                    ...
                    <GlassCard className="p-5">
                      ...
                      <div className="mt-2 flex items-end gap-2">
                        <span className="font-display text-2xl">
                          {Math.round(result.complexity * 100)}
                        </span>
                    ...
                    {result.estimatedSavingsUsd > 0 && (
                      <div className="flex items-center gap-4 p-4 rounded-lg bg-primary/10 border border-primary/20">
                        ...
                        <div className="text-right">
                          ...
                          <div className="font-display text-2xl prism-text">
                            ${result.estimatedSavingsUsd.toFixed(5)}
                          </div>
                        </div>
                      </div>
                    )}
